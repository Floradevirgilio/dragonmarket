          ...
          @if (auth()->check()) {{-- chequeo si hay un user autenticado  --}}
            ...
            <ul class='navbar-nav' style="padding-top: 1em">
              ...
              @endif
                <li class='nav-item'>
                    <a class="nav-link"
                        href="{{route('actualizarDatosPersonales.show', ['user_id' => auth()->user()->id])}}"><span>
                        <i class="fas fa-user"
                            style="font-size: 1em"></i> {{ auth()->user()->first_name }}</span>
                    </a>
                </li>
                <li class='nav-item'>
                    <a class='nav-link'
                        ...
                        <i class="fas fa-sign-out-alt"
                            style="font-size: 1em"></i>Cerrar Sesión
                    </a>
                </li>
              ...
              @else
                ...
                <li class='nav-item'>
                    <a class='nav-link' href='/login'>
                        <i class="fas fa-sign-in-alt" style="font-size: 1em"></i>Ingreso
                    </a>
                </li>
                <li class='nav-item'>
                    <a class='nav-link' href='/register'>
                        <i class="fas fa-user-edit"
                            style="font-size: 1em"></i>Registro
                    </a>
                </li>
              @endif
                <li class='nav-item'>
