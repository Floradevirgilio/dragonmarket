            ...
            @endif
              ...
              <div class="container column col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                {{ Form::open(['url' => '/adminNewProduct', 'method' => 'post'], ['class' =>'container column col-xs-12 col-sm-12 col-md-12 col-lg-12']) }}
                  ...
                  <br>
                    {!! Form::text('description', null,['class' => 'form-control column col-xs-10 col-sm-10 col-md-12 col-lg-12' . ($errors->has('description') ? ' is-invalid' : ''),'required placeholder'=>'Descripción del producto.']) !!}
                  <br>
              ...
              {{--  ---> poner la carga de fotografía --}}
                ...
                {!! Form::number('price', null, ['class' => 'form-control column col-xs- col-sm-2 col-md-3 col-lg-3' . ($errors->has('price') ? ' is-invalid' : ''), 'required placeholder' => '0,00', 'step' => '0.1']) !!}
                ...
                <strong>{!!  Form::label('stock', 'En stock:') !!}</strong>
                  {{--  Esto viene si es crear un producto nuevo --}}
                 {!! Form::number('stock', null, ['class' => 'form-control column col-xs- col-sm-1 col-md-2 col-lg-2' . ($errors->has('stock') ? ' is-invalid' : ''), 'required placeholder' => 1]) !!}
