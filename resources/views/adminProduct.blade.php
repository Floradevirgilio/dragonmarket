            ...
            <div class="row justify-content-center" style="margin-top: 2em;">
              ...
              <div class="container column col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                {{ Form::open(['url' => '/adminProduct', 'method' => 'post'], ['class' =>'container column col-xs-12 col-sm-12 col-md-12 col-lg-12']) }}
                  ...
                  <br>
                    {!! Form::select('category',$categories,null,['placeholder' => 'Seleccioná la categoría','id'=>'category', 'class' => 'form-control column col-xs-10 col-sm-10 col-md-12 col-lg-12']) !!}
                  <br>
              ...
              {{--  ---> poner la carga de fotografía --}}
                ...
                {!! Form::number('number', null, ['class' => 'form-control column col-xs- col-sm-2 col-md-3 col-lg-3', 'required placeholder' => '0,00', 'step' => '0.1']) !!}
