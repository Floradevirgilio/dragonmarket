...
// el home y el método que busca en la db los productos para mostrar
Route::get('/', 'MainController@homeShowProducts'); Route::get('/showProducts/{id?}', 'ProductController@showProducts'); // los productos a mostrar por buscador o por categoría
...
Route::resource('abmUser', 'UserController');
...
// log/reg antes para poder comprar
Route::get('/logInToShop', function() { return view('/logInToShop'); }); 
...
// https://youtu.be/NfDKrVXc8_Y
Route::resource('cart_product', 'CartProductController', [ 'only' => 'store', 'destroy' ]); 
...
Route::resource('abmCategory', 'CategoryController');
...
Route::resource('abmProduct', 'ProductController');
