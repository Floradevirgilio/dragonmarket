  ...
  <div id="main" class="container">
    <div class="container">
      <div class="row justify-content-around">
        <div class="jumbotron column col-xs-5 col-sm-5 col-md-6 col-lg-6 shadow p-4 mb-4 border border-info" style="margin-top: 50px;">
          <div class="row justify-content-center">

          </div>
          <div class="row justify-content-center" style="margin-top: 2em;">
            <h2 text-shadow: 2px 2px #ff0000><i class="fas fa-user-edit" style="font-size: 1em; margin-right: .3em"></i>REGISTRO</h2>
          </div>
          ...
          <form "POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}" enctype="multipart/form-data">
            ...
            <center><div class="row justify-content-center">
              <a class="btn btn-link" href="{{ route('login') }}">
                <i class="fas fa-sign-in-alt" style="font-size: 1em"></i> {{ __('Ya tengo una cuenta') }} </a>
              </div>
            </center>
          </div>
        </form>
