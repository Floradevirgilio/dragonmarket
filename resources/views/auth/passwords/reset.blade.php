            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.request') }}" aria-label="{{ __('Reset Password') }}">
                        ...
                        <div class="form-group row">
                            <label for="pass-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirma la Contraseña') }}</label>

                            <div class="col-md-6">
                                <input id="pass-confirm" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
